...
1. 1. null 값이 있으면 안되는 정수 4자리
2. 2. 가변 10바이트 문자열
3. 3 가변 9바이트 문자열
4. 4.정수형 4자리
5. 5.날짜
6. 실수형 7자리 소숫점 2자리까지만 반올림하여 표기
7. 실수형 7자리 소숫점 2자리까지만 반올림하여 표기
8. 정수형 2자리
...
![[Pasted image 20240118122824.png]]


![[Pasted image 20240118160123.png]]
**![[Pasted image 20240119091205.png]]**
